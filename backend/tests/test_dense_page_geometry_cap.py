...
asserted narratively. Production behavior (the default, "legacy_area")
is intentionally left unchanged in this phase — see
docs/geometry_graph_audit/08_prioritized_roadmap.md P0.1 and
...
class DensePageCapTests(unittest.TestCase):
    ...
    def test_default_strategy_is_legacy_area_and_unchanged(self) -> None:
